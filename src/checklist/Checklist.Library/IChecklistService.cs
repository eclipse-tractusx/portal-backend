...
public interface IChecklistService
{
    ...
    /// <param name="cancellationToken">Cancellation Token</param>
    Task ProcessChecklist(Guid applicationId, IEnumerable<(ChecklistEntryTypeId TypeId, ChecklistEntryStatusId StatusId)> checklistEntries, CancellationToken cancellationToken);
}
