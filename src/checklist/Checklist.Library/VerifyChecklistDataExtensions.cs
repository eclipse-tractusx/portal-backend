...
public static class VerifyChecklistDataExtensions
{
    public static void ValidateChecklistData(
    ...
    public static IChecklistService.ManualChecklistProcessStepData CreateManualChecklistProcessStepData(this VerifyChecklistData checklistData, Guid applicationId, ApplicationChecklistEntryTypeId entryTypeId, ProcessStep processStep)
    {
