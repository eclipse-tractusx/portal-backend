...
{
    public async static IAsyncEnumerable<TItem> CatchingAsync<TItem>(this IAsyncEnumerable<TItem> asyncItems, Action<Exception> handler, [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
