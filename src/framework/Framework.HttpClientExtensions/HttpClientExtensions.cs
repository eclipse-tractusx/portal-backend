...
{
    public static IServiceCollection AddCustomHttpClientWithAuthentication<T>(this IServiceCollection services) where T : class =>
        services.AddCustomHttpClientWithAuthentication<T>(typeof(T).Name, null);
