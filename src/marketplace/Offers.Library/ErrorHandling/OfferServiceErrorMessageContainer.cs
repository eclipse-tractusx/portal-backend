...
public class OfferServiceErrorMessageContainer : IErrorMessageContainer
{
    private static readonly IReadOnlyDictionary<int, string> _messageContainer = new Dictionary<OfferServiceErrors, string> {
                ...
                { OfferServiceErrors.AGREEMENTS_NOT_VALID_FOR_OFFER, "agreements {0} are not valid for offer {1}" },
                ...
                { OfferServiceErrors.MANDATORY_DOCUMENT_TYPES_MISSING, "{0} are mandatory document types, ({1} are missing)" },
                ...
                { OfferServiceErrors.OFFER_DOES_NOT_EXIST, "{offerTypeId} {offerId} does not exist" },
                { OfferServiceErrors.MISSING_PROPERTIES, "Missing: {0}" },
                ...
                { OfferServiceErrors.OFFER_STATUS_IN_REVIEW, "{0} must be in status {1}" },
                ...
                { OfferServiceErrors.LANGUAGE_CODES_NOT_EXIST, "Language code(s) do(es) not exist" },
                ...
                { OfferServiceErrors.OFFER_LOCKED_STATE, "{offerTypeId} {offer.OfferId} is in locked state" },
                ...
                { OfferServiceErrors.DOCUMENTSTATUS_DELETION_NOT_ALLOWED, "Document in State {result.DocumentStatusId} can't be deleted" },
                ...
                { OfferServiceErrors.INVALID_CONFIGURATION_ROLES_NOT_EXIST, "invalid configuration, at least one of the configured roles does not exist in the database: {0}" },
