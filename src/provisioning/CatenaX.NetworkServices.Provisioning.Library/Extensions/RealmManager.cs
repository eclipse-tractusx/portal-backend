...
public partial class ProvisioningManager
{
    ...
    private async ValueTask UpdateSharedRealmAsync(string alias, string displayName)
    {
    ...
    private async ValueTask SetSharedRealmStatusAsync(string alias, bool enabled)
    {
        var realm = await _SharedIdp.GetRealmAsync(alias).ConfigureAwait(false);
