...
public record IdentityProviderEditableConfigOidc(string Alias, string DisplayName, bool Enabled, string MetadataUrl, IamIdentityProviderClientAuthMethod ClientAuthMethod, string ClientId, string? Secret = null, IamIdentityProviderSignatureAlgorithm? SignatureAlgorithm = null);
