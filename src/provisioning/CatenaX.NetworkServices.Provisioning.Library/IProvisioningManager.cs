...
public interface IProvisioningManager
{
    ...
    Task UpdateCentralIdentityProviderDataOIDCAsync(string alias, string displayName, bool enabled, string authorizationUrl, IamIdentityProviderClientAuthMethod clientAuthMethod, string clientId, string? secret = null);
