...
using Org.Eclipse.TractusX.Portal.Backend.Processes.Synchronization.Executor.DependencyInjection;
    ...
    var host = Host
        ...
        .ConfigureServices((hostContext, services) =>
        {
            services
                ...
                .AddIdentityProviderSyncProcessExecutor(hostContext.Configuration);
