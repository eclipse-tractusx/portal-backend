...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20240404075620_CPLP-3548-declineRegistration")]
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.IdentityProvider", b =>
                {
                    ...
                    b.HasIndex("ProcessId")
                        .IsUnique()
                        .HasDatabaseName("ix_identity_providers_process_id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ProcessStepType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 500,
                            Label = "TRIGGER_DELETE_IDP_SHARED_REALM"
                        },
                        new
                        {
                            Id = 501,
                            Label = "TRIGGER_DELETE_IDP_SHARED_SERVICEACCOUNT"
                        },
                        new
                        {
                            Id = 502,
                            Label = "TRIGGER_DELETE_IDENTITY_LINKED_USERS"
                        },
                        new
                        {
                            Id = 503,
                            Label = "TRIGGER_DELETE_CENTRAL_IDENTITY_PROVIDER"
                        },
                        new
                        {
                            Id = 504,
                            Label = "TRIGGER_DELETE_IDENTITY_PROVIDER"
                        },
                        new
                        {
                            Id = 505,
                        ...
                        {
                            Id = 507,
                            Label = "RETRIGGER_DELETE_IDENTITY_LINKED_USERS"
                        },
                        new
                        {
                            Id = 508,
                        ...
                        {
                            Id = 509,
                            Label = "RETRIGGER_DELETE_IDENTITY_PROVIDER"
                        });
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.IdentityProvider", b =>
                {
                    ...
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Process", "Process")
                        ...
                        .HasForeignKey("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.IdentityProvider", "ProcessId")
                        .HasConstraintName("fk_identity_providers_processes_process_id");
