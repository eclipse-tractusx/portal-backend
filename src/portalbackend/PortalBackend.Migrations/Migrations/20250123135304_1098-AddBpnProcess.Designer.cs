...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20250123135304_1098-AddBpnProcess")]
    partial class _1098AddBpnProcess
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStepType<Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Process, Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Enums.ProcessTypeId, Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Enums.ProcessStepTypeId>", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 900,
                            Label = "DELETE_BPN_FROM_CENTRAL_USER"
                        },
                        new
                        {
                            Id = 901,
                            Label = "DELETE_BPN_FROM_IDENTITY"
                        },
                        new
                        {
                            Id = 902,
                            Label = "RETRIGGER_DELETE_BPN_FROM_CENTRAL_USER"
                        },
                        new
                        {
                            Id = 904,
                            Label = "CHECK_LEGAL_ENTITY_DATA"
                        },
                        new
                        {
                            Id = 905,
                            Label = "ADD_BPN_TO_IDENTITY"
                        },
                        new
                        {
                            Id = 906,
                            Label = "CLEANUP_USER_BPN"
                        },
                        new
                        {
                            Id = 907,
                            Label = "RETRIGGER_CHECK_LEGAL_ENTITY_DATA"
                        },
                        new
                        {
                            Id = 908,
                            Label = "RETRIGGER_ADD_BPN_TO_IDENTITY"
                        });
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.CompanyUserAssignedBusinessPartner", b =>
                {
                    ...
                    b.HasIndex("ProcessId")
                        .HasDatabaseName("ix_company_user_assigned_business_partners_process_id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.CompanyUserAssignedBusinessPartner", b =>
                {
                    ...
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.Process", "Process")
                        .WithMany()
                        .HasForeignKey("ProcessId")
                        .HasConstraintName("fk_company_user_assigned_business_partners_processes_process_id");
