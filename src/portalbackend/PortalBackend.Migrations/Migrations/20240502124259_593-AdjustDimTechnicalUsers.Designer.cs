...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20240502124259_593-AdjustDimTechnicalUsers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.AuditEntities.AuditUserRole20240502", b =>
                {
                    b.Property<Guid>("AuditV1Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("ProviderInformationId")
                        .HasColumnType("integer")
                        .HasColumnName("provider_information_id");
                    ...
                    b.HasKey("AuditV1Id")
                        .HasName("pk_audit_user_role20240502");

                    b.ToTable("audit_user_role20240502", "portal");
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ProviderInformation", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_provider_informations");

                    b.ToTable("provider_informations", "portal");

                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthUrl = "https://example.org/oauth/token",
                            Name = "Keycloak"
                        });
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.UserRole", b =>
                {
                    ...
                    b.HasIndex("ProviderInformationId")
                        .HasDatabaseName("ix_user_roles_provider_information_id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.UserRole", b =>
                {
                    ...
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ProviderInformation", "ProviderInformation")
                        .WithMany("UserRole")
                        .HasForeignKey("ProviderInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_roles_provider_informations_provider_information_id");
