...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20250903081557_multi-shared-idp-background-process")]
    partial class multisharedidpbackgroundprocess
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.SharedIdpInstanceDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("AuthRealm")
                        .HasColumnType("text")
                        .HasColumnName("auth_realm");
                    ...
                    b.Property<int>("MaxRealmCount")
                        .HasColumnType("integer")
                        .HasColumnName("max_realm_count");

                    b.Property<int>("RealmUsed")
                        .HasColumnType("integer")
                        .HasColumnName("realm_used");

                    b.Property<string>("SharedIdpUrl")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("shared_idp_url");

                    b.Property<bool>("UseAuthTrail")
                        .HasColumnType("boolean")
                        .HasColumnName("use_auth_trail");

                    b.HasKey("Id")
                        .HasName("pk_shared_idp_instance_details");

                    b.ToTable("shared_idp_instance_details", "portal");
                });

            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.SharedIdpRealmMapping", b =>
                {
                    b.Property<Guid>("SharedIdpInstanceDetailId")
                        .HasColumnType("uuid")
                        .HasColumnName("shared_idp_instance_detail_id");

                    b.Property<string>("RealmName")
                        .HasColumnType("text")
                        .HasColumnName("realm_name");

                    b.HasKey("SharedIdpInstanceDetailId", "RealmName")
                        .HasName("pk_shared_idp_realm_mappings");

                    b.ToTable("shared_idp_realm_mappings", "portal");
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.SharedIdpRealmMapping", b =>
                {
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.SharedIdpInstanceDetail", "SharedIdpInstanceDetail")
                        .WithMany("SharedIdpRealmMappings")
                        .HasForeignKey("SharedIdpInstanceDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_shared_idp_realm_mappings_shared_idp_instance_details_share");

                    b.Navigation("SharedIdpInstanceDetail");
                });
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.SharedIdpInstanceDetail", b =>
                {
                    b.Navigation("SharedIdpRealmMappings");
                });
