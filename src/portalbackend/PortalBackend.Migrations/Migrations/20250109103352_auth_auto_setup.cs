...
{
    /// <inheritdoc />
    public partial class auth_auto_setup : Migration
    {
        private const string SchemaName = "portal";
        private const string TableName = "provider_company_details";
        private const string Byte = "bytea";
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    client_secret = table.Column<byte[]>(type: Byte, nullable: true),
                    initialization_vector = table.Column<byte[]>(type: Byte, nullable: true),
