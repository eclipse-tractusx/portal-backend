...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20230103124432_CPLP-1963-AddChecklist")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ApplicationChecklistEntry", b =>
                {
                    ...
                    b.Property<int>("ChecklistEntryTypeId")
                        .HasColumnType("integer")
                        .HasColumnName("checklist_entry_type_id");
                    ...
                    b.HasIndex("ApplicationId")
                        .HasDatabaseName("ix_application_checklist_application_id");

                    b.HasIndex("ChecklistEntryTypeId")
                        .HasDatabaseName("ix_application_checklist_checklist_entry_type_id");

                    b.HasIndex("StatusId")
                        .HasDatabaseName("ix_application_checklist_status_id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ChecklistEntryStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_checklist_entry_status");

                    b.ToTable("checklist_entry_status", "portal");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ChecklistEntryType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_checklist_entry_type");

                    b.ToTable("checklist_entry_type", "portal");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ApplicationChecklistEntry", b =>
                {
                    ...
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ChecklistEntryType", "ChecklistEntryType")
                        .WithMany("ApplicationChecklistEntries")
                        .HasForeignKey("ChecklistEntryTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_application_checklist_checklist_entry_type_checklist_entry_");

                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.ChecklistEntryStatus", "Status")
                        .WithMany("ApplicationChecklistEntries")
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_application_checklist_checklist_entry_status_status_id");

                    b.Navigation("Application");

                    b.Navigation("ChecklistEntryType");
