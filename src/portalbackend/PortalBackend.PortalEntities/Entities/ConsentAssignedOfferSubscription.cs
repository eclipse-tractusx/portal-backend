...
public class ConsentAssignedOfferSubscription
{
    private ConsentAssignedOfferSubscription() {}

    public ConsentAssignedOfferSubscription(Guid offerSubscriptionId, Guid consentId)
    {
