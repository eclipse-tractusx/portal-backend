...
public enum ProcessStepTypeId
{
    ...
    // IDPDELETION
    TRIGGER_DELETE_IDP_SHARED_REALM = 600,
    TRIGGER_DELETE_IDP_SHARED_SERVICEACCOUNT = 601,
    TRIGGER_DELETE_IDENTITY_LINKED_USERS = 602,
    TRIGGER_DELETE_CENTRAL_IDENTITY_PROVIDER = 603,
    TRIGGER_DELETE_IDENTITY_PROVIDER = 604,
    RETRIGGER_DELETE_IDP_SHARED_REALM = 605,
    RETRIGGER_DELETE_IDP_SHARED_SERVICEACCOUNT = 606,
    RETRIGGER_DELETE_IDENTITY_LINKED_USERS = 607,
    RETRIGGER_DELETE_CENTRAL_IDENTITY_PROVIDER = 608,
    RETRIGGER_DELETE_IDENTITY_PROVIDER = 609
}
