...
public enum ProcessStepTypeId
{
    ...
    RETRIGGER_TRIGGER_PROVIDER = 107,
    RETRIGGER_OFFERSUBSCRIPTION_CLIENT_CREATION = 108,
    RETRIGGER_SINGLE_INSTANCE_SUBSCRIPTION_DETAILS_CREATION = 109,
    RETRIGGER_OFFERSUBSCRIPTION_TECHNICALUSER_CREATION = 110,
    RETRIGGER_ACTIVATE_SUBSCRIPTION = 111,
    RETRIGGER_TRIGGER_PROVIDER_CALLBACK = 113,
}
