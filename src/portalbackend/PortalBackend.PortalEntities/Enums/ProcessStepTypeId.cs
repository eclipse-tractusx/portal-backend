...
public enum ProcessStepTypeId
{
    ...
    // INVITATION
    INVITATION_SETUP_IDP = 401,
    INVITATION_CREATE_DATABASE_IDP = 402,
    INVITATION_CREATE_USER = 403,
    INVITATION_SEND_MAIL = 404,
    RETRIGGER_INVITATION_SETUP_IDP = 405,
    RETRIGGER_INVITATION_CREATE_USER = 406,
    RETRIGGER_INVITATION_CREATE_DATABASE_IDP = 407,
    RETRIGGER_INVITATION_SEND_MAIL = 408
}
