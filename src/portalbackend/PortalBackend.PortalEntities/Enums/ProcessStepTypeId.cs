...
public enum ProcessStepTypeId
{
    ...
    INVITATION_CREATE_CENTRAL_IDP_ORG_MAPPER = 403,
    INVITATION_CREATE_SHARED_REALM_IDP_CLIENT = 404,
    INVITATION_ENABLE_CENTRAL_IDP = 405,
    INVITATION_CREATE_DATABASE_IDP = 406,
    INVITATION_CREATE_USER = 407,
    INVITATION_SEND_MAIL = 408,
    RETRIGGER_INVITATION_CREATE_CENTRAL_IDP = 409,
    RETRIGGER_INVITATION_CREATE_SHARED_IDP_SERVICE_ACCOUNT = 410,
    RETRIGGER_INVITATION_UPDATE_CENTRAL_IDP_URLS = 411,
    RETRIGGER_INVITATION_CREATE_CENTRAL_IDP_ORG_MAPPER = 412,
    RETRIGGER_INVITATION_CREATE_SHARED_REALM_IDP_CLIENT = 413,
    RETRIGGER_INVITATION_ENABLE_CENTRAL_IDP = 414,
    RETRIGGER_INVITATION_CREATE_USER = 415,
    RETRIGGER_INVITATION_CREATE_DATABASE_IDP = 416,
    RETRIGGER_INVITATION_SEND_MAIL = 417
}
