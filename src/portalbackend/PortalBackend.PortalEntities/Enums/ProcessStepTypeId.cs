...
public enum ProcessStepTypeId
{
    ...
    // IDPDELETION
    TRIGGER_DELETE_IDP_SHARED_REALM = 500,
    TRIGGER_DELETE_IDP_SHARED_SERVICEACCOUNT = 501,
    TRIGGER_DELETE_IDENTITY_LINKED_USERS = 502,
    TRIGGER_DELETE_CENTRAL_IDENTITY_PROVIDER = 503,
    TRIGGER_DELETE_IDENTITY_PROVIDER = 504,
    RETRIGGER_DELETE_IDP_SHARED_REALM = 505,
    RETRIGGER_DELETE_IDP_SHARED_SERVICEACCOUNT = 506,
    RETRIGGER_DELETE_IDENTITY_LINKED_USERS = 507,
    RETRIGGER_DELETE_CENTRAL_IDENTITY_PROVIDER = 508,
    RETRIGGER_DELETE_IDENTITY_PROVIDER = 509
}
