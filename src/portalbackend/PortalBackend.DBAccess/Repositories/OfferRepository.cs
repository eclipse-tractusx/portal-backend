...
public class OfferRepository : IOfferRepository
{
    ...
    /// <inheritdoc />
    public IAsyncEnumerable<(Guid Id, string? Name, string VendorCompanyName, IEnumerable<string> UseCaseNames, IEnumerable<Guid> LeadPictureIds, string? ShortDescription, string? LicenseText)> GetAllActiveAppsAsync(string? languageShortName) =>
        _context.Offers.AsNoTracking()
            ...
            .Select(a => new ValueTuple<Guid,string?,string,IEnumerable<string>,IEnumerable<Guid>,string?,string?>(
                a.Id,
                a.Name,
                ...
                a.Documents.Where(document => document.DocumentTypeId == DocumentTypeId.APP_LEADIMAGE && document.DocumentStatusId != DocumentStatusId.INACTIVE).Select(document => document.Id),
