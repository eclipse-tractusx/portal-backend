...
public class OfferRepository : IOfferRepository
{
    ...
    /// <inheritdoc />
    public IAsyncEnumerable<(Guid Id, string? Name, string VendorCompanyName, IEnumerable<string> UseCaseNames, IEnumerable<Guid> LeadPictureId, string? ShortDescription, string? LicenseText)> GetAllActiveAppsAsync(string? languageShortName) =>
