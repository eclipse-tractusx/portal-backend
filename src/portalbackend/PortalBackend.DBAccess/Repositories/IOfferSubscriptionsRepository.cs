...
public interface IOfferSubscriptionsRepository
{
    ...
    Task<VerifyOfferSubscriptionProcessData?> GetProcessStepData(Guid offerSubscriptionId, IEnumerable<ProcessStepTypeId> processStepTypeIds, bool mustBePending);
