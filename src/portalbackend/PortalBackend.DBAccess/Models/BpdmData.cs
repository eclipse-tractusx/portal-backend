...
public record BpdmData(CompanyApplicationStatusId ApplicationStatusId, string Bpn, string CompanyName, string AlphaCode2, string ZipCode, string City, string Street, bool IsUserInCompany);
