...

{
    public class PortalBackendDBAccess : IPortalBackendDBAccess
    {
        ...
        public IAsyncEnumerable<InvitedUsers> GetInvitedUsersDetail(Guid applicationId)
        {
            var result = (from invitation in _dbContext.Invitations
                          ...
                          where invitation.CompanyApplicationId.ToString() == applicationId.ToString()
                          select new InvitedUsers
                          {
