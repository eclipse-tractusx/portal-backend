...
public class AdministrationSubscriptionConfigurationErrorMessageContainer : IErrorMessageContainer
{
    private static readonly IReadOnlyDictionary<int, string> _messageContainer = new Dictionary<AdministrationSubscriptionConfigurationErrors, string> {
                ...
                { AdministrationSubscriptionConfigurationErrors.SUBSCRIPTION_CONFLICT_AUTO_SETUP_NOT_FOUND, "Company {companyId} does not have auto setup configured" },
                { AdministrationSubscriptionConfigurationErrors.SUBSCRIPTION_FORBIDDEN_COMPANY_NOT_PROVIDER, "Company {companyId} is not an App/Service provider"},
                { AdministrationSubscriptionConfigurationErrors.SUBSCRIPTION_CONFLICT_CLIENT_MUST_SET, "Client id should not be null or empty"},
                { AdministrationSubscriptionConfigurationErrors.SUBSCRIPTION_CONFLICT_SECRET_MUST_SET, "Client secret should not be null or empty"},
