...
* **Connector URL**: Updating connector URL for connectors with missing SD Document is not working. [#1346](https://github.com/eclipse-tractusx/portal-backend/issues/1346)
