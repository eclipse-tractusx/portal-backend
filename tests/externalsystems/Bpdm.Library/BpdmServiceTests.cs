...
public class BpdmServiceTests
{
    ...
    public async Task FetchInputLegalEntity_WithValidResult_ReturnsExpected()
    {
        ...
        result.Identifiers.Should().HaveCount(21)
            .And.Satisfy(
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_DE && x.Value == "DE234567890",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_CZ && x.Value == "CZ12345678",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_PL && x.Value == "PL1234567890",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_BE && x.Value == "BE1234567890",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_CH && x.Value == "CHE123456789",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_DK && x.Value == "DK12345678",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_ES && x.Value == "ES12345678",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_GB && x.Value == "GB12345678",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_NO && x.Value == "NO12345678",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_FR && x.Value == "FR12345678901",
                x => x.Type == BpdmIdentifierId.CH_UID && x.Value == "CHE-123.456.789",
                x => x.Type == BpdmIdentifierId.FR_SIREN && x.Value == "12345678901",
                x => x.Type == BpdmIdentifierId.EU_VAT_ID_AT && x.Value == "ATU12345678",
                x => x.Type == BpdmIdentifierId.DE_BNUM && x.Value == "12345670",
                x => x.Type == BpdmIdentifierId.CZ_ICO && x.Value == "12345671",
                x => x.Type == BpdmIdentifierId.BE_ENT_NO && x.Value == "1234567890",
                x => x.Type == BpdmIdentifierId.CVR_DK && x.Value == "12345672",
                x => x.Type == BpdmIdentifierId.ID_CRN && x.Value == "12345673",
                x => x.Type == BpdmIdentifierId.NO_ORGID && x.Value == "12345674",
                x => x.Type == BpdmIdentifierId.LEI_ID && x.Value == "12345675",
                x => x.Type == BpdmIdentifierId.DUNS_ID && x.Value == "283329464"
            );
    }
