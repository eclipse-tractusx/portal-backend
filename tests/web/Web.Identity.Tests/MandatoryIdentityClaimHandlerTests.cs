...
public class MandatoryIdentityClaimHandlerTests
{
    ...
    public MandatoryIdentityClaimHandlerTests()
    {
        ...
        A.CallTo(() => _identityRepository.GetActiveIdentityDataByUserEntityId(_subject_service_account)).Returns((_serviceAccountId, IdentityTypeId.TECHNICAL_USER, _serviceAccountCompanyId));
    ...
    [InlineData("client_id", "valid_client", PolicyTypeId.ValidIdentity, IClaimsIdentityDataBuilderStatus.Complete, true, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    [InlineData("client_id", "valid_client", PolicyTypeId.CompanyUser, IClaimsIdentityDataBuilderStatus.Complete, false, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    [InlineData("client_id", "valid_client", PolicyTypeId.ServiceAccount, IClaimsIdentityDataBuilderStatus.Complete, true, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    [InlineData("client_id", "valid_client", PolicyTypeId.ValidCompany, IClaimsIdentityDataBuilderStatus.Complete, true, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    ...
    [InlineData("sub", "valid_sub_service_account", PolicyTypeId.ValidIdentity, IClaimsIdentityDataBuilderStatus.Complete, true, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    [InlineData("sub", "valid_sub_service_account", PolicyTypeId.CompanyUser, IClaimsIdentityDataBuilderStatus.Complete, false, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    [InlineData("sub", "valid_sub_service_account", PolicyTypeId.ServiceAccount, IClaimsIdentityDataBuilderStatus.Complete, true, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
    [InlineData("sub", "valid_sub_service_account", PolicyTypeId.ValidCompany, IClaimsIdentityDataBuilderStatus.Complete, true, "53472768-6cb5-41b0-9421-5c956e44e8c8", IdentityTypeId.TECHNICAL_USER, "a61092d7-1516-4ccf-b922-0308bbb087e3")]
