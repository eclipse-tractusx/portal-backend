...
public class RegistrationBusinessLogicTest
{
    ...
    public RegistrationBusinessLogicTest()
    {
        ...
        _logic = new RegistrationBusinessLogic(_portalRepositories, _options, _checklistService, _clearinghouseBusinessLogic, _sdFactoryBusinessLogic, _dimBusinessLogic, _provisioningManager, logger);
    }
    ...
    public async Task UpdateCompanyBpnAsync_WithUseDimWalletFalse_CallsExpected(bool useDimWallet, ProcessStepTypeId expectedProcessStepTypeId)
    {
        ...
        var logic = new RegistrationBusinessLogic(_portalRepositories, options, _checklistService, null!, null!, _dimBusinessLogic, _provisioningManager, null!);
    ...
    public async Task SetRegistrationVerification_WithApproval_CallsExpected(bool useDimWallet, ProcessStepTypeId expectedTypeId)
    {
        // Arrange
        var options = Options.Create(new RegistrationSettings { UseDimWallet = useDimWallet });
        var logic = new RegistrationBusinessLogic(_portalRepositories, options, _checklistService, null!, null!, _dimBusinessLogic, null!, null!);
