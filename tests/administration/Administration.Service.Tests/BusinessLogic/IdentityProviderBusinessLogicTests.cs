...
public class IdentityProviderBusinessLogicTests
{
    ...
    public async Task UploadOwnCompanyUsersIdentityProviderLinkDataAsync_EmailChanged_Success()
    {
        ...
        var changedEmailResult = default(string?);
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithNotSupportedProtocol_ThrowsControllerArgumentException()
    {
        ...
        // Act
        async Task Act() => await sut.CreateOwnCompanyIdentityProviderAsync(default, IdentityProviderTypeId.OWN, null);
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithDisplayNameToLong_ThrowsControllerArgumentException(string display)
    {
        ...
        // Act
        async Task Act() => await sut.CreateOwnCompanyIdentityProviderAsync(IamIdentityProviderProtocol.SAML, IdentityProviderTypeId.OWN, display);
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithInvalidCharacterInDisplayName_ThrowsControllerArgumentException()
    {
        ...
        // Act
        async Task Act() => await sut.CreateOwnCompanyIdentityProviderAsync(IamIdentityProviderProtocol.SAML, IdentityProviderTypeId.OWN, "$invalid-character");
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithInvalidCompany_ThrowsControllerArgumentException()
    {
        ...
        // Act
        async Task Act() => await sut.CreateOwnCompanyIdentityProviderAsync(IamIdentityProviderProtocol.SAML, IdentityProviderTypeId.OWN, null);
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithNotAllowedCompanyForManaged_ThrowsForbiddenException()
    {
        ...
        // Act
        async Task Act() => await sut.CreateOwnCompanyIdentityProviderAsync(IamIdentityProviderProtocol.SAML, IdentityProviderTypeId.MANAGED, null);
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithShared_ThrowsForbiddenException()
    {
        ...
        // Act
        async Task Act() => await sut.CreateOwnCompanyIdentityProviderAsync(IamIdentityProviderProtocol.OIDC, IdentityProviderTypeId.SHARED, null);
    ...
    public async Task CreateOwnCompanyIdentityProviderAsync_WithValidData_ExecutesExpected(IamIdentityProviderProtocol protocol, IdentityProviderTypeId typeId, IEnumerable<CompanyRoleId> companyRoleIds)
    {
        ...
        // Act
        var result = await sut.CreateOwnCompanyIdentityProviderAsync(protocol, typeId, "test-company");
    ...
    public async Task DeleteCompanyIdentityProviderAsync_WithNotExistingProvider_ThrowsNotFoundException()
    {
        ...
        // Act
        async Task Act() => await sut.DeleteCompanyIdentityProviderAsync(invalidId);
    ...
    public async Task DeleteCompanyIdentityProviderAsync_WithInvalidCompany_ThrowsConflictException()
    {
        ...
        // Act
        async Task Act() => await sut.DeleteCompanyIdentityProviderAsync(identityProviderId);
    ...
    public async Task DeleteCompanyIdentityProviderAsync_WithSharedKeycloakValid_CallsExpected()
    {
        ...
        A.CallTo(() => _identityProviderRepository.GetOwnCompanyIdentityProviderUpdateDataForDelete(A<Guid>._, A<Guid>._))
            .Returns((true, "test", IdentityProviderTypeId.SHARED, new[] { (_companyId, new[] { "other-alias" }.AsEnumerable()) }, string.Empty));
        ...
        // Act
        await sut.DeleteCompanyIdentityProviderAsync(identityProviderId);
    ...
    public async Task DeleteCompanyIdentityProviderAsync_WithManagedIdp_ExecutesExpected(bool multipleIdps)
    {
        ...
        A.CallTo(() => _userRepository.AttachAndModifyIdentities(A<IEnumerable<(Guid, Action<Identity>?, Action<Identity>)>>._))
    ...
    public async Task GetOwnCompanyIdentityProviderAsync_WithDifferentCompany_ThrowsConflictException()
    {
        ...
        // Act
        async Task Act() => await sut.GetOwnCompanyIdentityProviderAsync(identityProviderId);
    ...
    public async Task GetOwnCompanyIdentityProviderAsync_WithOidcWithoutExistingKeycloakClient_CallsExpected()
    {
        ...
        // Act
        var result = await sut.GetOwnCompanyIdentityProviderAsync(identityProviderId);
    ...
    public async Task GetOwnCompanyIdentityProviderAsync_WithValidOidc_CallsExpected()
    {
        // Arrange
        var identityProviderId = Guid.NewGuid();
        var details = _fixture.Build<IdentityProviderConfigOidc>()
            .With(x => x.Enabled, true)
            .With(x => x.DisplayName, "dis-oidc")
            .With(x => x.ClientSecret, "******")
            .Create();
        var sut = new IdentityProviderBusinessLogic(
            _portalRepositories,
            _provisioningManager,
        ...
        result.Oidc.Should().Match<IdentityProviderDetailsOidc>(x =>
            x.MetadataUrl == "http://metadata" &&
            x.AuthorizationUrl == details.AuthorizationUrl &&
            x.TokenUrl == details.TokenUrl &&
            x.LogoutUrl == details.LogoutUrl &&
            x.ClientId == details.ClientId &&
            x.HasClientSecret &&
            x.ClientAuthMethod == details.ClientAuthMethod &&
            x.SignatureAlgorithm == details.SignatureAlgorithm);
    }
    ...
    public async Task SetOwnCompanyIdentityProviderStatusAsync_WithDifferentCompany_ThrowsNotFoundExecption()
    {
        ...
        // Act
        async Task Act() => await sut.SetOwnCompanyIdentityProviderStatusAsync(identityProviderId, false);
    ...
    public async Task SetOwnCompanyIdentityProviderStatusAsync_WithNoOtherCompany_CallsExpected()
    {
        ...
        // Act
        var result = await sut.SetOwnCompanyIdentityProviderStatusAsync(identityProviderId, false);
    ...
    public async Task SetOwnCompanyIdentityProviderStatusAsync_DisableWithValidOidc_CallsExpected()
    {
        ...
        // Assert
        A.CallTo(() => _identityProviderRepository.GetOwnCompanyIdentityProviderStatusUpdateData(identityProviderId, _companyId, true)).MustHaveHappenedOnceExactly();
        A.CallTo(() => _provisioningManager.IsCentralIdentityProviderEnabled("cl1")).MustNotHaveHappened();
        A.CallTo(() => _provisioningManager.IsCentralIdentityProviderEnabled("alt-cl1")).MustHaveHappenedOnceExactly();
        A.CallTo(() => _provisioningManager.IsCentralIdentityProviderEnabled("foo")).MustHaveHappenedOnceExactly();
        A.CallTo(() => _provisioningManager.SetCentralIdentityProviderStatusAsync("cl1", false)).MustHaveHappenedOnceExactly();
        result.Mappers.Should().HaveCount(3);
        result.DisplayName.Should().Be("dis-oidc");
        result.Enabled.Should().BeTrue();
    ...
    [Fact]
    public async Task SetOwnCompanyIdentityProviderStatusAsync_EnableWithValidOidc_CallsExpected()
    {
        // Arrange
        var identityProviderId = Guid.NewGuid();
        var sut = new IdentityProviderBusinessLogic(
        ...
        // Act
        var result = await sut.SetOwnCompanyIdentityProviderStatusAsync(identityProviderId, true);

        // Assert
        A.CallTo(() => _identityProviderRepository.GetOwnCompanyIdentityProviderStatusUpdateData(identityProviderId, _companyId, false)).MustHaveHappenedOnceExactly();
        A.CallTo(() => _provisioningManager.IsCentralIdentityProviderEnabled(A<string>._)).MustNotHaveHappened();
        A.CallTo(() => _provisioningManager.SetCentralIdentityProviderStatusAsync("cl1", true)).MustHaveHappenedOnceExactly();
        result.Mappers.Should().HaveCount(3);
        result.DisplayName.Should().Be("dis-oidc");
    ...
    [Fact]
    public async Task SetOwnCompanyIdentityProviderStatusAsync_DisableWithValidSaml_CallsExpected()
    {
        // Arrange
        var identityProviderId = Guid.NewGuid();
        var sut = new IdentityProviderBusinessLogic(
        ...
        A.CallTo(() => _provisioningManager.IsCentralIdentityProviderEnabled(A<string>._)).Returns(true);
    ...
    public async Task UpdateOwnCompanyIdentityProviderAsync_ForOidcWithOidcNull_ThrowsControllerArgumentException()
    {
        ...
        var identityProviderId = Guid.NewGuid();
        var data = _fixture.Build<IdentityProviderEditableDetails>()
            .With(x => x.Oidc, default(IdentityProviderEditableDetailsOidc?))
            .With(x => x.DisplayName, "new-display-name")
            .Create();
        var sut = new IdentityProviderBusinessLogic(
            _portalRepositories,
    ...
    public async Task UpdateOwnCompanyIdentityProviderAsync_WithValidOidc_CallsExpected()
    {
        ...
        var identityProviderId = Guid.NewGuid();
        var data = _fixture.Build<IdentityProviderEditableDetails>()
            .With(x => x.Oidc, _fixture.Build<IdentityProviderEditableDetailsOidc>().With(x => x.Secret, "test").With(x => x.MetadataUrl, "http://new").Create())
        ...
        A.CallTo(() => _provisioningManager.GetIdentityProviderMappers("cl1"))
            .Returns(_fixture.CreateMany<IdentityProviderMapperModel>(3).ToAsyncEnumerable());
        IamIdentityProvider? initialIamIdentityProvider = null;
        IamIdentityProvider? modifiedIamIdentityProvider = null;
        A.CallTo(() => _identityProviderRepository.AttachAndModifyIamIdentityProvider(A<string>._, A<Action<IamIdentityProvider>>._, A<Action<IamIdentityProvider>>._))
            .Invokes((string alias, Action<IamIdentityProvider>? initialize, Action<IamIdentityProvider> modify) =>
            {
                initialize?.Invoke(initialIamIdentityProvider = new IamIdentityProvider(alias, Guid.Empty));
                modify(modifiedIamIdentityProvider = new IamIdentityProvider(alias, Guid.Empty));
            });

        // Act
        var result = await sut.UpdateOwnCompanyIdentityProviderAsync(identityProviderId, data, cancellationToken);
        ...
        result.DisplayName.Should().Be("dis-oidc");
        result.Enabled.Should().BeTrue();
        A.CallTo(() => _identityProviderRepository.AttachAndModifyIamIdentityProvider("cl1", A<Action<IamIdentityProvider>>._, A<Action<IamIdentityProvider>>._))
            .MustHaveHappenedOnceExactly();
        initialIamIdentityProvider.Should().Match<IamIdentityProvider>(x =>
            x.IamIdpAlias == "cl1" &&
            x.MetadataUrl == "http://old");
    ...
    public async Task CreateOrUpdateOwnCompanyUserIdentityProviderLinkDataAsync_WithValid_CallsExpected()
    {
        ...
        // Act
        var result = await sut.CreateOrUpdateOwnCompanyUserIdentityProviderLinkDataAsync(companyUserId, identityProviderId, data);
    ...
    public async Task GetOwnCompanyUserIdentityProviderLinkDataAsync_WithValid_CallsExpected()
    {
        ...
        // Act
        var result = await sut.GetOwnCompanyUserIdentityProviderLinkDataAsync(companyUserId, identityProviderId);
    ...
    public async Task DeleteOwnCompanyUserIdentityProviderDataAsync_WithKeycloakError_ThrowsNotFound()
    {
        ...
        // Act
        async Task Act() => await sut.DeleteOwnCompanyUserIdentityProviderDataAsync(companyUserId, identityProviderId);
    ...
    public async Task DeleteOwnCompanyUserIdentityProviderDataAsync_WithValid_CallsExpected()
    {
        ...
        // Act
        await sut.DeleteOwnCompanyUserIdentityProviderDataAsync(companyUserId, identityProviderId);
    ...
    public async Task GetOwnCompanyUsersIdentityProviderDataAsync_WithoutIdentityProviderIds_ThrowsControllerArgumentException()
    {
        ...
        // Act
        async Task Act() => await sut.GetOwnCompanyUsersIdentityProviderDataAsync(Enumerable.Empty<Guid>(), false).ToListAsync();
    ...
    public async Task GetOwnCompanyUsersIdentityProviderDataAsync_WithoutMatchingIdps_ThrowsControllerArgumentException()
    {
        ...
        // Act
        async Task Act() => await sut.GetOwnCompanyUsersIdentityProviderDataAsync(Enumerable.Repeat(identityProviderId, 1), false).ToListAsync();
    ...
    public async Task GetOwnIdentityProviderWithConnectedCompanies_WithDifferentCompany_ThrowsConflictException()
    {
        ...
        // Act
        async Task Act() => await sut.GetOwnIdentityProviderWithConnectedCompanies(identityProviderId);
    ...
    public async Task GetOwnIdentityProviderWithConnectedCompanies_WithOidcWithoutExistingKeycloakClient_CallsExpected()
    {
        ...
        // Act
        var result = await sut.GetOwnIdentityProviderWithConnectedCompanies(identityProviderId);
        ...
        switch (protocol)
        {
            case IamIdentityProviderProtocol.OIDC:
                A.CallTo(() => _provisioningManager.GetCentralIdentityProviderDataOIDCAsync(A<string>._))
                    .Returns(new IdentityProviderConfigOidc("test-oidc", "https://redirect.com/*", "https://token.com", "https://logout.com", "cl1-oidc", "********", true, "https://auth.com", IamIdentityProviderClientAuthMethod.SECRET_JWT, IamIdentityProviderSignatureAlgorithm.RS512));
                break;
