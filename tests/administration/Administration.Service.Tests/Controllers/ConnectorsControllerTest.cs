...
public class ConnectorsControllerTest
{
    ...
    public async Task CreateConnectorAsync_WithValidData_ReturnsExpectedResult()
    {
        ...
        A.CallTo(() => _logic.CreateConnectorAsync(connectorInputModel, AccessToken, IamUserId))
        ...
        //Assert
        A.CallTo(() => _logic.CreateConnectorAsync(connectorInputModel, AccessToken, IamUserId)).MustHaveHappenedOnceExactly();
