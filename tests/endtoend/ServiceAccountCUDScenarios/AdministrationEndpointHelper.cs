...
public static class AdministrationEndpointHelper
{
    ...
    public static async Task<ServiceAccountDetails> CreateNewServiceAccount(string[] permissions)
    {
        ...
        var allServiceAccountsRoles = await GetAllServiceAccountRoles();
    ...
    public static async Task<bool> DeleteServiceAccount(string serviceAccountId)
    {
        var data = Given()
            ...
            .Extract()
            .Response();
        return !(await data.Content.ReadAsStringAsync()).Equals("0");
    }
    ...
    public static async Task<ServiceAccountDetails> ResetServiceAccountCredentialsById(string serviceAccountId)
    {
        ...
        var resetServiceAccountCredentialsById = DataHandleHelper.DeserializeData<ServiceAccountDetails>(await response.Content.ReadAsStringAsync());
    ...
    public static async Task<ServiceAccountDetails> GetServiceAccountDetailsById(string serviceAccountId)
    {
        ...
        var response = Given()
            ...
            .Extract()
            .Response();
        return DataHandleHelper.DeserializeData<ServiceAccountDetails>(await response.Content.ReadAsStringAsync()) ?? throw new Exception($"Could not get service account details by id from {endpoint}, response was null/empty.");
    }
    ...
    private static async Task<List<UserRoleWithDescription>> GetAllServiceAccountRoles()
    {
        ...
        var response = Given()
            ...
            .Extract()
            .Response();
        var userRoleWithDescriptions = DataHandleHelper.DeserializeData<List<UserRoleWithDescription>>(await response.Content.ReadAsStringAsync());
