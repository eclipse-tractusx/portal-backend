...
public class PublicUrlActiveParticipantTests : BasePublicUrlTests<ServicesController, ActiveParticipantSeeding>
{
    public PublicUrlActiveParticipantTests(IntegrationTestFactory<ServicesController, ActiveParticipantSeeding> factory)
        : base(factory)
    { }
