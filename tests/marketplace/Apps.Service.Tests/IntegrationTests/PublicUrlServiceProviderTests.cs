...
public class PublicUrlServiceProviderTests : BasePublicUrlTests<AppsController, ServiceProviderSeeding>
{
    public PublicUrlServiceProviderTests(IntegrationTestFactory<AppsController, ServiceProviderSeeding> factory)
        : base(factory)
    { }
