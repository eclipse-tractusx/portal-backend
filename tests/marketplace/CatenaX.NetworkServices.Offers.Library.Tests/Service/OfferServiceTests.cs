...
public class OfferServiceTests
{
    ...
    public async Task CreateOfferAgreementConsentAsync_WithValidDataAndEmptyDescriptions_ReturnsCorrectDetails()
    {
        ...
        // Act
        var result = await sut.CreateOfferAgreementConsentAsync(_existingServiceId, _existingAgreementId, statusId, _iamUser.UserEntityId, OfferTypeId.SERVICE);
    ...
    public async Task CreateOfferAgreementConsentAsync_WithNotExistingAgreement_ThrowsException()
    {
        ...
        // Act
        async Task Action() => await sut.CreateOfferAgreementConsentAsync(_existingServiceId, Guid.NewGuid(), ConsentStatusId.ACTIVE, _iamUser.UserEntityId, OfferTypeId.SERVICE);
    ...
    public async Task CreateOfferAgreementConsentAsync_WithWrongUser_ThrowsException()
    {
        ...
        // Act
        async Task Action() => await sut.CreateOfferAgreementConsentAsync(_existingServiceId, _existingAgreementId, ConsentStatusId.ACTIVE, Guid.NewGuid().ToString(), OfferTypeId.SERVICE);
    ...
    public async Task GetServiceConsentDetailData_WithValidId_ReturnsServiceConsentDetailData()
    {
        ...
        // Act
        var result = await sut.GetConsentDetailDataAsync(_validConsentId).ConfigureAwait(false);
    ...
    public async Task GetServiceConsentDetailData_WithInvalidId_ThrowsException()
    {
        ...
        // Act
        async Task Action() => await sut.GetConsentDetailDataAsync(notExistingId).ConfigureAwait(false);
