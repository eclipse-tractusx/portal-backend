...
public class RegistrationBusinessLogicTest
{
    ...
    public async Task GetRegistrationDataAsync_ReturnsExpected()
    {
        ...
        var sut = new RegistrationBusinessLogic(_options, null!, null!, null!, _portalRepositories, null!, _identityService, _dateTimeProvider, _mailingProcessCreation);
    ...
    public async Task DeclineApplicationRegistrationAsync_CallsExpected()
    {
        ...
        // Act
        await sut.DeclineApplicationRegistrationAsync(applicationId).ConfigureAwait(false);
    ...
    public async Task DeclineApplicationRegistrationAsync_ThrowsNotFoundException_ReturnsExpected()
    {
        ...
        // Act
        var Act = async () => await sut.DeclineApplicationRegistrationAsync(applicationId).ConfigureAwait(false);
